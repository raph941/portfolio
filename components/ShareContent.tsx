    ...
    <StyledWrapper className={classNames(className, '')}>
        <ul className="social-items-list">
            <li className="social-item">
                ...
                >
                    <FacebookIcon width={25} height={25} alt="Facebook icon" />
                </a>
            </li>
            <li className="social-item">
                <a
                ...
                >
                    <TwitterIcon width={25} height={25} alt="Twitter icon" />
                </a>
            </li>
            <li className="social-item">
                <a
                ...
                >
                    <LinkedinIcon width={25} height={25} alt="LinkedIn icon" />
                </a>
            </li>
            <li className="social-item">
                <a
                ...
                >
                    <WhatsappIcon width={25} height={25} alt="Whatsapp icon" />
                </a>
            </li>
        </ul>
    </StyledWrapper>
