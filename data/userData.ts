...
export const userData = {
    ...
    portfolio: {
        ...
        featuredProjects: [
            {
                ...
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666300464/portfolio/opulent_m8ab0s.gif',
                description:
            ...
            },
            {
                ...
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666299925/portfolio/portfolio_c8qvtl.gif',
                description:
            ...
            },
            {
                ...
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666299358/portfolio/dabafinance_mec33x.gif',
                description:
            ...
            {
                title: 'Chat App',
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666300975/portfolio/chat_wf4qsx.gif',
                description:
                    'This is a fun fullstack project I worked on, to demonstrait building a real time chat application using django and react web socket.',
                stacks: [
                    'React',
                    'Typescript',
                    'Django/Python',
        ...
        otherProjects: [
            {
                title: 'Travel Site',
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666301446/portfolio/travel_zdavtj.gif',
                description: 'A travel agency template site.',
                stacks: ['HTML/CSS/JS'],
            ...
            },
            {
                ...
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666301954/portfolio/tariamulani_rjuhbi.gif',
                description:
                ...
                codeHost: 'https://github.com/raph941/ArtistPortfolio',
            },
            {
                title: 'App Landing Page',
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666302112/portfolio/Screenshot_2022-10-20_at_10.41.36_PM_ocjy2v.png',
                description:
            ...
            },
            {
                ...
                image: 'https://res.cloudinary.com/raph941/image/upload/v1666302527/portfolio/covid_oxdym6.gif',
                description: 'App that plots live data of of covid 19 cases, on chart and map',
